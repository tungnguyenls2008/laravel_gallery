...
@if(isset($employees) && is_object($employees))
    <section class="page_section team" id="team"><!--main-section team-start-->
        <div class="container">
            <h2>Our Artist</h2>
            <h6>Our work, our passion, our love.</h6>
...
<footer class="footer_wrapper" id="contact">
            ...
            <div class="row">
                <div class="col-lg-4 wow fadeInLeft">
                    <div class="contact_info">
                        <div class="detail">
                            <h4>Tung Nguyen</h4>
                            <p>S2.09, Vinhomes Ocean Park, Hanoi, Vietnam</p>
                        </div>
                        <div class="detail">
                            <h4>Phone</h4>
                            <p>+86 914 831 089</p>
                        ...
                        <div class="detail">
                            <h4>Email</h4>
                            <p>tungnguyenls2008@gmail.com</p>
                        </div>
                    </div>

                    <ul class="social_links">

                        <li class="instagram animated bounceIn wow delay-02s"><a href="https://www.instagram.com/tungnguyenls2008"><i class="fa fa-instagram"></i></a></li>
                ...
                <div class="col-lg-8 wow fadeInLeft delay-06s">
                    ...
                    <form action = "{{route('send')}}" method = "POST">
                        @csrf
                        <input class="input-text" type="text" name="name" placeholder="Your name" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;" required>
                        <input class="input-text" type="text" name="phone" placeholder="Your phone" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;" required>
                        <input class="input-text" type="text" name="email" placeholder="Your email" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;" required>
                        <textarea class="input-text text-area" name="text" cols="0" rows="0" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;">What do you want to tell me?</textarea>
                        <input class="input-btn" type="submit" value="SEND ME!">
                    </form>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © 2020,    Site by <a href="/">TungNguyen</a> </span> </div>
    </div>
</footer>
